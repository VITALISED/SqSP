...
var mpopTimer = 0;
mmenucolor='#DEE3E7';  //菜单背景
mfontcolor='#3D5A83';  //标题字体颜色
mmenuoutcolor='#f7f9fd';  //菜单选中背景
mmenuincolor='#f7f9fd';  //标题选中背景
mmenuoutbordercolor='#efefef';  //菜单左边框
mmenuinbordercolor='#9caab5';  //菜单右边框
mmidoutcolor='#A9DA1D';
mmidincolor='#799310';
mmenuovercolor='#004080';  //选中后字体颜色
mitemedge='0';
msubedge='1';
mmenuunitwidth=66;
mmenuitemwidth=90;
...
mmenuadjust=0;
mmenuadjustV=0;
mfonts='font-family: 宋体; font-size: 12px; color: #3D5A83; ';  //标题默认字体颜色
mcursor='hand';
var swipeSteps = 4;
var swipemsec = 25;
...
function mwritetodocument(){
      var mwb=1;
                     ...
                     for(var x=0;x<mmenus.length;x++){
                     	...
                     	stringx += "<td nowrap  valign=middle class=coolButton id=mMenu"+x+" style='border: "+mitemedge+"px solid "+mmenucolor+
 				...
 				stringx += "mmenuitem_up();mexec("+x+","+i+"); ";
 				  if(thismenuitem.pos=="0"){
                     		...
                     		stringx+='<tr><td height="1" bgcolor="'+mfontcolor+'" onmousemove="clearTimeout(mpopTimer);"></td></tr>\n';
                     		}
                     	}stringx+='</table>\n</div>'
                     	}                     	
                }
